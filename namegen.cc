...
int main() {
    std::array<std::string, 93> left = {
        {"admiring",      "adoring",    "affectionate",
         "agitated",      "amazing",    "angry",
         "awesome",       "blissful",   "boring",
         "brave",         "clever",     "cocky",
         "compassionate", "competent",  "condescending",
         "confident",     "cranky",     "dazzling",
         "determined",    "distracted", "dreamy",
         "eager",         "ecstatic",   "elastic",
         "elated",        "elegant",    "eloquent",
         "epic",          "fervent",    "festive",
         "flamboyant",    "focused",    "friendly",
         "frosty",        "gallant",    "gifted",
         "goofy",         "gracious",   "happy",
         "hardcore",      "heuristic",  "hopeful",
         "hungry",        "infallible", "inspiring",
         "jolly",         "jovial",     "keen",
         "kind",          "laughing",   "loving",
         "lucid",         "mystifying", "modest",
         "musing",        "naughty",    "nervous",
         "nifty",         "nostalgic",  "objective",
         "optimistic",    "peaceful",   "pedantic",
         "pensive",       "practical",  "priceless",
         "quirky",        "quizzical",  "relaxed",
         "reverent",      "romantic",   "sad",
         "serene",        "sharp",      "silly",
         "sleepy",        "stoic",      "stupefied",
         "suspicious",    "tender",     "thirsty",
         "trusting",      "unruffled",  "upbeat",
         "vibrant",       "vigilant",   "vigorous",
         "wizardly",      "wonderful",  "xenodochial",
         "youthful",      "zealous",    "zen"}};

    std::array<std::string, 173> right = {
        {// Muhammad ibn Jābir al-Ḥarrānī al-Battānī was a founding father of
         ...
         // June Almeida - Scottish virologist who took the first pictures of
         // the rubella virus - https://en.wikipedia.org/wiki/June_Almeida
         "almeida",

         // Maria Gaetana Agnesi - Italian mathematician, philosopher,
         ...
         // Aryabhata - Ancient Indian mathematician-astronomer during 476-550
         // CE https://en.wikipedia.org/wiki/Aryabhata
         "aryabhata",

         // Wanda Austin - Wanda Austin is the President and CEO of The
         // Aerospace Corporation, a leading architect for the US security space
         // programs. https://en.wikipedia.org/wiki/Wanda_Austin
         "austin",
         ...
         // inventor, engineer and innovator who is credited with inventing the
         ...
         // Research. Colloquially known as "father of Indian nuclear
         // programme"- https://en.wikipedia.org/wiki/Homi_J._Bhabha
         "bhabha",
         ...
         // gave rules to compute with zero -
         ...
         // book Silent Spring and other writings are credited with advancing
         ...
         // research on vinca alkaloids, development of drugs for treatment of
         // epilepsy and malaria -
         // https://en.wikipedia.org/wiki/Asima_Chatterjee
         "chatterjee",

         // Pafnuty Chebyshev - Russian mathematitian. He is known fo his works
         // on probability, statistics, mechanics, analytical geometry and
         // number theory https://en.wikipedia.org/wiki/Pafnuty_Chebyshev
         "chebyshev",
         ...
         // War who pioneered techniques that remained top secret for decades.
         ...
         // Alexandra Asanovna Elbakyan (Russian: Алекса́ндра Аса́новна Элбакя́н)
         // is a Kazakhstani graduate student, computer programmer, internet
         // pirate in hiding, and the creator of the site Sci-Hub. Nature has
         // listed her in 2016 in the top ten people that mattered in science,
         // and Ars Technica has compared her to Aaron Swartz. -
         ...
         // long-running Russian scientific TV show, Evident, but Incredible.
         // His father was the Nobel laureate Soviet-era physicist Pyotr
         // Kapitsa, and his brother was the geographer and Antarctic explorer
         ...
         // and mechanics, academician of the USSR Academy of Sciences (1946),
         ...
         // Nobel Laureate in Physiology or Medicine for discovering
         // transposons. https://en.wikipedia.org/wiki/Barbara_McClintock
         "mcclintock",
         ...
         // Periodic Law, created a farsighted version of the periodic table of
         ...
         // the first female member of the Royal Statistical Society and a
         ...
         // in 1925, proposed in her Ph.D. thesis an explanation for the
         // composition of stars in terms of the relative abundances of hydrogen
         // and helium. https://en.wikipedia.org/wiki/Cecilia_Payne-Gaposchkin
         "payne",
         ...
         // by open source crypto tools, advances the causes of truth and
         // freedom of information by reporting disclosures by whistleblowers
         // such as Edward Snowden. https://en.wikipedia.org/wiki/Laura_Poitras
         "poitras",
         ...
         // contributed significantly to the deciphering of Maya hieroglyphs,
         // the writing system of the pre-Columbian Maya civilization of
         // Mesoamerica. https://en.wikipedia.org/wiki/Tatiana_Proskouriakoff
         "proskuriakova",
         ...
         // Laureate in Physiology or Medicine; her work was fundamental in
         // identifying HIV as the cause of AIDS.
         ...
         // movement, the GNU project, the Free Software Foundation, and the
         // League for Programming Freedom. He also invented the concept of
         // copyleft to protect the ideals of this movement, and enshrined this
         // concept in the widely-used GPL (General Public License) for
         // software. https://en.wikiquote.org/wiki/Richard_Stallman
         "stallman",
         ...
         // the fronts of World War II. She is best known for her pioneering
         // work on blood–brain barrier, which she described as
         ...
         // Commons, Reddit, and much of the internet as we know it today. He
         // was devoted to freedom of information on the web.
         ...
         // politician. She was the first woman flying to space in 1963. In
         // 2013, at the age of 76, she offered to go on a one-way mission to
         // mars. https://en.wikipedia.org/wiki/Valentina_Tereshkova
         "tereshkova",
         ...
         // Physiology or Medicine in 1995 for research on the genetic control
         ...
         // Prize and Poincaré Price for his work in differential geometry and
         ...
         // enigmatic Fermat's Last Theorem -
         ...
         // flight - https://en.wikipedia.org/wiki/Wright_brothers
         "wright",

         // Rosalyn Sussman Yalow - Rosalyn Sussman Yalow was an American
         // medical physicist, and a co-winner of the 1977 Nobel Prize in
         // Physiology or Medicine for development of the radioimmunoassay
         // technique. https://en.wikipedia.org/wiki/Rosalyn_Sussman_Yalow
         "yalow",
         ...
         // mathematician and engineer, and a founding father of modern aero-
         // and hydrodynamics. Whereas contemporary scientists scoffed at the
         // idea of human flight, Zhukovsky was the first to undertake the study
