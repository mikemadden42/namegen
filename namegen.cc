...
int main() {
    ...
    std::vector<std::string> right = {{
        ...
        // Frances E. Allen, became the first female IBM Fellow in 1989. In
        // 2006, she became the first female recipient of the ACM's Turing
        // Award. https://en.wikipedia.org/wiki/Frances_E._Allen
        "allen",
        ...
        // Kathleen Antonelli, American computer programmer and one of the six
        ...
        // Buckaroo Banzai and his mentor Dr. Hikita perfected the "oscillation
        ...
        // Research. Colloquially known as "father of Indian nuclear programme"-
        ...
        // instrumental in saving Bletchley Park, the site of World War II
        // codebreaking -
        // https://en.wikipedia.org/wiki/Sue_Black_(computer_scientist)
        "black",

        // Elizabeth Helen Blackburn - Australian-American Nobel laureate; best
        // known for co-discovering telomerase.
        ...
        // Technology. She researches computational methods for imaging, and
        // developed an algorithm that made possible the picture first
        ...
        // hundreds of thousands of stars and created the system we use to
        // understand stars today.
        // https://en.wikipedia.org/wiki/Annie_Jump_Cannon
        "cannon",

        // Rachel Carson - American marine biologist and conservationist, her
        // book Silent Spring and other writings are credited with advancing the
        // global environmental movement.
        // https://en.wikipedia.org/wiki/Rachel_Carson
        "carson",

        // Dame Mary Lucy Cartwright - British mathematician who was one of the
        // first to study what is now known as chaos theory. Also known for
        // Cartwright's theorem which finds applications in signal processing.
        // https://en.wikipedia.org/wiki/Mary_Cartwright
        "cartwright",

        // George Washington Carver - American agricultural scientist and
        // inventor. He was the most prominent black scientist of the early 20th
        // century. https://en.wikipedia.org/wiki/George_Washington_Carver
        "carver",

        // Vinton Gray Cerf - American Internet pioneer, recognised as one of
        // "the fathers of the Internet". With Robert Elliot Kahn, he designed
        // TCP and IP, the primary data communication protocols of the Internet
        // and other computer networks. https://en.wikipedia.org/wiki/Vint_Cerf
        "cerf",
        ...
        // Sergey Alexeyevich Chaplygin (Russian: Серге́й Алексе́евич Чаплы́гин;
        // April 5, 1869 – October 8, 1942) was a Russian and Soviet physicist,
        // mathematician, and mechanical engineer. He is known for mathematical
        // formulas such as Chaplygin's equation and for a hypothetical
        // substance in cosmology called Chaplygin gas, named after him.
        // https://en.wikipedia.org/wiki/Sergey_Chaplygin
        "chaplygin",

        // Émilie du Châtelet - French natural philosopher, mathematician,
        // physicist, and author during the early 1730s, known for her
        // translation of and commentary on Isaac Newton's book Principia
        // containing basic laws of physics.
        // https://en.wikipedia.org/wiki/%C3%89milie_du_Ch%C3%A2telet
        "chatelet",

        // Asima Chatterjee was an Indian organic chemist noted for her research
        // on vinca alkaloids, development of drugs for treatment of epilepsy
        ...
        // woman—and first American woman—to win a Nobel Prize in science, and
        // the first woman to be awarded the Nobel Prize in Physiology or
        // Medicine. Cori was born in Prague.
        ...
        // A. K. (Alexander Keewatin) Dewdney, Canadian mathematician, computer
        // scientist, author and filmmaker. Contributor to Scientific American's
        // "Computer Recreations" from 1984 to 1991. Author of Core War
        // (program), The Planiverse, The Armchair Universe, The Magic Machine,
        // The New Turing Omnibus, and more.
        // https://en.wikipedia.org/wiki/Alexander_Dewdney
        "dewdney",

        // Satish Dhawan - Indian mathematician and aerospace engineer, known
        // for leading the successful and indigenous development of the Indian
        // space programme. https://en.wikipedia.org/wiki/Satish_Dhawan
        "dhawan",
        ...
        // Agnes Meyer Driscoll - American cryptanalyst during World Wars I and
        // II who successfully cryptanalysed a number of Japanese ciphers. She
        // was also the co-developer of one of the cipher machines of the US
        // Navy, the CM. https://en.wikipedia.org/wiki/Agnes_Meyer_Driscoll
        "driscoll",
        ...
        // Alexandra Asanovna Elbakyan (Russian: Алекса́ндра Аса́новна Элбакя́н) is
        // a Kazakhstani graduate student, computer programmer, internet pirate
        // in hiding, and the creator of the site Sci-Hub. Nature has listed her
        // in 2016 in the top ten people that mattered in science, and Ars
        // Technica has compared her to Aaron Swartz. -
        // https://en.wikipedia.org/wiki/Alexandra_Elbakyan
        "elbakyan",

        // Taher A. ElGamal - Egyptian cryptographer best known for the ElGamal
        // discrete log cryptosystem and the ElGamal digital signature scheme.
        ...
        // the GCHQ. Best known for conceiving for the first time, the idea of
        // public-key cryptography. https://en.wikipedia.org/wiki/James_H._Ellis
        "ellis",
        ...
        // Horst Feistel - German-born American cryptographer who was one of the
        // earliest non-government researchers to study the design and theory of
        // block ciphers. Co-developer of DES and Lucifer. Feistel networks, a
        // symmetric structure used in the construction of block ciphers are
        // named after him. https://en.wikipedia.org/wiki/Horst_Feistel
        "feistel",
        ...
        // Yuri Alekseyevich Gagarin - Soviet pilot and cosmonaut, best known as
        ...
        // foundations of Galois theory and group theory, two major branches of
        // abstract algebra, and the subfield of Galois connections, all while
        // still in his late teens.
        // https://en.wikipedia.org/wiki/%C3%89variste_Galois
        "galois",

        // Kadambini Ganguly - Indian physician, known for being the first South
        // Asian female physician, trained in western medicine, to graduate in
        // South Asia. https://en.wikipedia.org/wiki/Kadambini_Ganguly
        "ganguly",
        ...
        // significant contributions to many fields, including number theory,
        ...
        // philosopher. Known for her work on elasticity theory, number theory
        // and philosophy. https://en.wikipedia.org/wiki/Sophie_Germain
        "germain",
        ...
        // winner of the 2009 Nobel Prize for Physiology or Medicine for the
        // discovery of telomerase.
        // https://en.wikipedia.org/wiki/Carol_W._Greider
        "greider",

        // Alexander Grothendieck - German-born French mathematician who became
        // a leading figure in the creation of modern algebraic geometry.
        ...
        // industry administrator and champion of women's rights. Co-author of
        // British Standard 1363 that specifies AC power plugs and sockets used
        // across the United Kingdom (which is widely considered as one of the
        // safest designs). https://en.wikipedia.org/wiki/Caroline_Haslett
        "haslett",
        ...
        // invention of public-key cryptography in co-operation with Whitfield
        // Diffie and Ralph Merkle. https://en.wikipedia.org/wiki/Martin_Hellman
        "hellman",
        ...
        // father of the electroanalytical method, and recipient of the Nobel
        // Prize in 1959. His main field of work was polarography.
        ...
        // and author of the Pulitzer Prize and American Book Award-winning work
        // Goedel, Escher, Bach: An Eternal Golden Braid in 1979. A mind-bending
        // work which coined Hofstadter's Law: "It always takes longer than you
        ...
        // Frances Hugle, she was an American scientist, engineer, and inventor
        // who contributed to the understanding of semiconductors, integrated
        ...
        // Joseon Dynasty; he invented the first metal printing press and water
        // gauge. https://en.wikipedia.org/wiki/Jang_Yeong-sil
        "jang",

        // Mae Carol Jemison -  is an American engineer, physician, and former
        // NASA astronaut. She became the first black woman to travel in space
        // when she served as a mission specialist aboard the Space Shuttle
        // Endeavour - https://en.wikipedia.org/wiki/Mae_Jemison
        "jemison",
        ...
        // February 1928 – 14 August 2012) was a Russian physicist and
        // demographer. He was best known as host of the popular and
        // long-running Russian scientific TV show, Evident, but Incredible. His
        // father was the Nobel laureate Soviet-era physicist Pyotr Kapitsa, and
        // his brother was the geographer and Antarctic explorer Andrey Kapitsa.
        // - https://en.wikipedia.org/wiki/Sergey_Kapitsa
        "kapitsa",

        // Susan Kare, created the icons and many of the interface elements for
        // the original Apple Macintosh in the 1980s, and was an original
        // employee of NeXT, working as the Creative Director.
        // https://en.wikipedia.org/wiki/Susan_Kare
        "kare",

        // Mstislav Keldysh - a Soviet scientist in the field of mathematics and
        // mechanics, academician of the USSR Academy of Sciences (1946),
        // President of the USSR Academy of Sciences (1961–1975), three times
        // Hero of Socialist Labor (1956, 1961, 1971), fellow of the Royal
        // Society of Edinburgh (1968).
        ...
        // Omar Khayyam - Persian mathematician, astronomer and poet. Known for
        // his work on the classification and solution of cubic equations, for
        // his contribution to the understanding of Euclid's fifth postulate and
        // for computing the length of a year very accurately.
        ...
        // Jack Kilby invented silicon integrated circuits and gave Silicon
        ...
        // known for his seminal work in distributed systems and was the winner
        // of the 2013 Turing Award.
        // https://en.wikipedia.org/wiki/Leslie_Lamport
        "lamport",

        // Mary Leakey - British paleoanthropologist who discovered the first
        // fossilized Proconsul skull -
        // https://en.wikipedia.org/wiki/Mary_Leakey
        "leakey",

        // Henrietta Swan Leavitt - she was an American astronomer who
        // discovered the relation between the luminosity and the period of
        ...
        // discovering in 1936 that the Earth has a solid inner core inside a
        // molten outer core. https://en.wikipedia.org/wiki/Inge_Lehmann
        "lehmann",

        // Daniel Lewin - Mathematician, Akamai co-founder, soldier, 9/11
        // victim-- Developed optimization techniques for routing traffic on the
        // internet. Died attempting to stop the 9-11 hijackers.
        ...
        // theorist and biologist, science author, educator, and popularizer,
        // and was the primary modern proponent for the significance of
        // symbiosis in evolution. - https://en.wikipedia.org/wiki/Lynn_Margulis
        "margulis",

        // Yukihiro Matsumoto - Japanese computer scientist and software
        // programmer best known as the chief designer of the Ruby programming
        // language. https://en.wikipedia.org/wiki/Yukihiro_Matsumoto
        "matsumoto",
        ...
        // Anne Laura Dorinthea McLaren - British developmental biologist whose
        // work helped lead to human in-vitro fertilisation.
        ...
        // Dmitri Mendeleev - a chemist and inventor. He formulated the Periodic
        // Law, created a farsighted version of the periodic table of elements,
        // and used it to correct the properties of some already discovered
        // elements and also to predict the properties of eight elements yet to
        // be discovered. https://en.wikipedia.org/wiki/Dmitri_Mendeleev
        "mendeleev",
        ...
        // Merkle's puzzles - one of the very first schemes for public-key
        // cryptography. Also, inventor of Merkle trees and co-inventor of the
        // Merkle-Damgård construction for building collision-resistant
        // cryptographic hash functions and the Merkle-Hellman knapsack
        ...
        // telegraph system based on European telegraphs and was a co-developer
        // of the Morse code - https://en.wikipedia.org/wiki/Samuel_Morse
        "morse",
        ...
        // astronomer, mathematician and physicist. Best known for his discovery
        // of logarithms. https://en.wikipedia.org/wiki/John_Napier
        "napier",

        // John Forbes Nash, Jr. - American mathematician who made fundamental
        // contributions to game theory, differential geometry, and the study of
        ...
        // Robert Noyce invented silicon integrated circuits and gave Silicon
        ...
        // Проскуряко́ва) (January 23 [O.S. January 10] 1909 – August 30, 1985)
        // was a Russian-American Mayanist scholar and archaeologist who
        // contributed significantly to the deciphering of Maya hieroglyphs, the
        ...
        // of the Saha equation, used to describe chemical and physical
        // conditions in stars - https://en.wikipedia.org/wiki/Meghnad_Saha
        "saha",
        ...
        // Mildred Sanderson - American mathematician best known for Sanderson's
        // theorem concerning modular invariants.
        // https://en.wikipedia.org/wiki/Mildred_Sanderson
        "sanderson",

        // Satoshi Nakamoto is the name used by the unknown person or group of
        // people who developed bitcoin, authored the bitcoin white paper, and
        ...
        // contributions to cryptography include the Ferge Fiat Shamir
        // identification scheme, the Rivest Shamir Adleman (RSA) public-key
        // cryptosystem, the Shamir's secret sharing scheme, the breaking of the
        // Merkle-Hellman cryptosystem, the TWINKLE and TWIRL factoring devices
        // and the discovery of differential cryptanalysis (with Eli Biham).
        ...
        // 26 August 1878 – 7 March 1968) was a Soviet biochemist, physiologist
        // and humanist whose medical discoveries saved thousands of lives at
        // the fronts of World War II. She is best known for her pioneering work
        // on blood–brain barrier, which she described as hemato-encephalic
        ...
        // in Physiology or Medicine; her work was fundamental in identifying
        ...
        // computer science and educational computing. Known for creation of
        ...
        // Commons, Reddit, and much of the internet as we know it today. He was
        // devoted to freedom of information on the web.
        ...
        // Helen Brooke Taussig - American cardiologist and founder of the field
        // of paediatric cardiology.
        // https://en.wikipedia.org/wiki/Helen_B._Taussig
        "taussig",

        // Valentina Tereshkova is a Russian engineer, cosmonaut and politician.
        // She was the first woman to fly to space in 1963. In 2013, at the age
        // of 76, she offered to go on a one-way mission to Mars.
        ...
        // co-created the first scientific map of the Atlantic Ocean floor. Her
        // work led to the acceptance of the theories of plate tectonics and
        // continental drift. https://en.wikipedia.org/wiki/Marie_Tharp
        "tharp",
        ...
        // discovering artemisinin and dihydroartemisinin, used to treat
        // malaria, which has saved millions of lives. Joint winner of the 2015
        ...
        // the SCOUT launch vehicle program that put America's first satellites
        ...
        // Sylvia B. Wilbur - British computer scientist who helped develop the
        // ARPANET, was one of the first to exchange email in the UK and a
        // leading researcher in computer-supported collaborative work.
        ...
        // employed by the GCHQ. Developed in 1974 what is now known as
        // Diffie-Hellman key exchange (Diffie and Hellman first published the
        // scheme in 1976). https://en.wikipedia.org/wiki/Malcolm_J._Williamson
        "williamson",
        ...
        // airflow. He is often called the Father of Russian Aviation.
    ...
    std::uniform_int_distribution<> dis_right(1,
