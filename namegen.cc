...
int main() {
  ...
  std::array<std::string, 160> right = {{
      ...
      // many things to list them here. https://en.wikipedia.org/wiki/Archimedes
      "archimedes",
      ...
      // Evelyn Boyd Granville - She was one of the first African-American woman
      // to receive a Ph.D. in mathematics; she earned it in 1949 from Yale
      ...
      // theory on different stages and evolution in structures of the stars. He
      // has won nobel prize for physics -
      ...
      // first American woman—to win a Nobel Prize in science, and the first
      // woman to be awarded the Nobel Prize in Physiology or Medicine. Cori was
      // born in Prague. https://en.wikipedia.org/wiki/Gerty_Cori
      "cori",
      ...
      // Grete Hermann was a German philosopher noted for her philosophical work
      ...
      // Mary Jackson, American mathematician and aerospace engineer who earned
      // the highest title within NASA's engineering department -
      ...
      // for his work on the development of ballistic missile and launch vehicle
      ...
      // Barbara Liskov - co-developed the Liskov substitution principle. Liskov
      // was also the winner of the Turing Prize in 2008. -
      ...
      // Maryam Mirzakhani - an Iranian mathematician and the first woman to win
      // the Fields Medal. https://en.wikipedia.org/wiki/Maryam_Mirzakhani
      "mirzakhani",

      // Samuel Morse - contributed to the invention of a single-wire telegraph
      // system based on European telegraphs and was a co-developer of the Morse
      // code - https://en.wikipedia.org/wiki/Samuel_Morse
      "morse",
      ...
      // Sally Kristen Ride was an American physicist and astronaut. She was the
      // first American woman in space, and the youngest American astronaut.
      ...
      // Nikola Tesla invented the AC electric system and every gadget ever used
      // by a James Bond villain. https://en.wikipedia.org/wiki/Nikola_Tesla
      "tesla",
